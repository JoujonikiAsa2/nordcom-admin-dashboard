...
import { getSingleBrand, updateBrand } from "@/services/brand";
...
const BrandFormEdit = () => {
  ...
  useEffect(() => {
    const fetchProductToEdit = async () => {
      const res = await getSingleBrand(id as string);
      setBrandForm((prev) => ({
        ...prev,
        name: res.name,
        description: res.description,
        isFeatured: res.isFeatured,
        logoPreview: res.logoUrl,
      }));
      setLoading(false);
    };
